...
const Draft = ({
  ...
  let orderTwo = [];
  let picks = [];
  if (startTime > 1617940800) { // post 7.29
    orderOne = [1, 3, 5, 8, 9, 11, 13, 16, 18, 19, 21, 23];
    orderTwo = [2, 4, 6, 7, 10, 12, 14, 15, 17, 20, 22, 24];
    picks = [5, 6, 7, 8, 15, 16, 17, 18, 23, 24];
  } else if (startTime > 1593316800) { // post 7.27
